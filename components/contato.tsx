        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          <div>
            ...
            <div className="space-y-6 mb-12">
              ...
              >
                <div className="w-12 h-12 border border-neutral-300 flex items-center justify-center group-hover:border-neutral-900 transition-colors">
              ...
              >
                <div className="w-12 h-12 border border-neutral-300 flex items-center justify-center group-hover:border-neutral-900 transition-colors">
                  <svg className="w-5 h-5 text-neutral-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center justify-between py-4 border-x border-b border-neutral-200 px-4">
              <div>
